...
namespace EXandIM.Web.Data.Migrations
{
    ...
    [Migration("20250919230740_edit_ReferenceNumber")]
    partial class edit_ReferenceNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EXandIM.Web.Core.Models.Book", b =>
                {
                    ...
                    b.Property<int?>("ReferenceNumberId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EXandIM.Web.Core.ReferenceNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EXandIM.Web.Core.Models.Book", b =>
                {
                    b.HasOne("EXandIM.Web.Core.ReferenceNumber", "ReferenceNumber")
                        .WithMany("Books")
                        .HasForeignKey("ReferenceNumberId");
